...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover" style="background-image: url(images/cover.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-bold">About Rangamati</h1>
            </div>
          </div>
        </div>
      </div>  
      ...
      <div class="container">
        <div class="row mb-3 align-items-stretch">
          <div class="col-12 text-center">
            <div class='h-entry'>
            <p>Rangamati is a district in south-eastern Bangladesh. It is a part of the Chittagong Division and the town of Rangamati serves as the headquarters of the district. Area-wise, Rangamati is the largest district of the country.</p> <br>
            <h2 class="font-size-regular">Tourist Places in Rangamati</h2><br>
          </div>
          </div>
        <?php
          $db=mysqli_connect("localhost", "root", "", "vromon_bd");
          $sql= "SELECT * FROM rangamati";
