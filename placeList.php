        ...
        <div class="row mb-3 align-items-stretch">
          ...
          ?>
              <div class="col-12 text-center">
                <div class='h-entry'>
                  <h2 class="font-size-regular">Find spot in <?php echo $distName;?></h2><br>
                </div>
              </div>
          ...
          <?php
              while($row = mysqli_fetch_array($result)) { ?>
                ...
                <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
                  <div class="h-entry">
                    <a href="placeList"><img src="<?php echo $row['Image']?>" alt="Image" class="img-fluid"></a>
                    <h2 class="font-size-regular"><a href="#"><?php echo $row['Name']?></a></h2>
