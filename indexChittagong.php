<?php
	...
	if (isset($_POST['upload'])) {
		...
		$sql="INSERT INTO chittagong (placeName, placeImage, placeDetails) VALUES ('$addName', '$image', '$text')";
		mysqli_query($db, $sql);
...
<body>
<div id="content">
	<form method="post" action="indexChittagong.php" enctype="multipart/form-data">
