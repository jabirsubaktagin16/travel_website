...
<html lang="en">
  ...
  <div class="site-wrap">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="chittagong_division.html">Chittagong</a></li>
                    <li class="active"><a href="dhaka_division.html">Dhaka</a></li>
    ...
    <div class="site-blocks-cover inner-page-cover" style="background-image: url(images/followmeto_dhaka_07.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-bold">About Dhaka</h1>
            </div>
          </div>
        </div>
      </div>  
