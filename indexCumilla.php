<?php
	...
	if (isset($_POST['upload'])) {
		...
		$sql="INSERT INTO cumilla (placeName, placeImage, placeDetails) VALUES ('$addName', '$image', '$text')";
		mysqli_query($db, $sql);
...
<body>
<div id="content">
	<form method="post" action="indexCumilla.php" enctype="multipart/form-data">
