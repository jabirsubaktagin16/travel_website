<?php
	...
	if (isset($_POST['upload'])) {
		...
		$sql="INSERT INTO bandarban (placeName, placeImage, placeDetails) VALUES ('$addName', '$image', '$text')";
		mysqli_query($db, $sql);
...
<body>
<div id="content">
	<form method="post" action="indexBandarban.php" enctype="multipart/form-data">
